...
This package ships self-contained: the internal `@substrata/core`, `@substrata/index`, and `@substrata/mcp-server` workspace packages are bundled in at build time.
